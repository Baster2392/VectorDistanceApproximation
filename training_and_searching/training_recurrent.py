...
def grid_search(criterion, optimizer_obj, scheduler_obj, hidden_dims_r, hidden_dims_fc, num_recurrent_layers_list, num_fc_layers_list, epochs, n_samples, loss_tolerance, device):
    ...
    with open(path, mode='a', newline='') as csv_file:
        ...
        for hidden_dim, hidden_dim_fc, num_layers_recurrent, num_layers_fc in itertools.product(hidden_dims_r, hidden_dims_fc, num_recurrent_layers_list, num_fc_layers_list):
            ...
            optimizer = optimizer_obj(model.parameters(), lr=learning_rate)
    ...
    for input_dim in input_dims:
        ...
        for i in range(1):
            ...
            best_params = grid_search(criterion, optimizer, scheduler, hidden_dims_r, hidden_dims_fc,
                                      ...
                                      epochs=5000000, n_samples=64, loss_tolerance=0.0001, device=device)
