...
with open('results.csv', mode='r') as file:
    ...
    for row in csv_reader:
        ...
        X, Y = generate_dataset(100000, input_dimension)
        ...
        train_loss, model, test_loss, epochs = train_and_evaluate_model(input_dimension, layers, learning_rate, weight_decay)
        ...
        with open('updated_results.csv', mode='a', newline="") as result_file:
            fieldnames = ['Input dimension', 'Number of Layers', 'Factor q', 'Meant Complexity', 'Actual Complexity',
                          'First Layer', 'Layers', 'Train Loss', 'Test Loss', 'Epochs']
