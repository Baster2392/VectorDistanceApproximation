...
def train(train_params):
    ...
    test_dataset_size = train_params['test_dataset_size']
...
test_loss = evaluate_model(trained_model, train_params['test_dataset_size'], train_params['input_dim'], train_params['criterion'], train_params['device'])
print(f"\nTest loss: {test_loss}")